# MedConnect India — Brand Voice Guidelines

Generated 2026-07-08 from site copy (landing page, app screens, footer). Source: `app/` in the medconnect-india project.
...
1. **Everything in one place** — directory, jobs, news, learning; "all in one place" is a recurring phrase.
2. **Real-time usefulness** — find doctors in real time, track visits, stay on top of availability.
3. **Career growth for MRs** — jobs by territory, learning center, "grow your pharma career."
4. **Trusted ecosystem** — named pharma partners, verified stats, testimonials from each user role.
...
- Headline: "One Platform for MRs, Doctors & Pharma Companies"
- Sub: "Find doctors in real time, discover jobs, track visits, and grow your pharma career — all in one place."
- App CTA: "Take MedConnect India Everywhere" / "Download the app to manage visits, track targets, and connect on the go."
- Footer: "Connecting India's pharmaceutical ecosystem — MRs, doctors, chemists, and companies, in one place."

## Open Questions

1. **Emoji in marketing (not just in-app)?** In-product copy uses 👋 ✅; landing copy uses none. *Recommendation: keep emoji in-product only.*
2. **Hindi/regional-language voice?** No source material yet. *Recommendation: English-first, flag localization as a future workstream.*
3. **Medical claims boundary** — news and drug content must stay factual and CDSCO-accurate; no efficacy claims in marketing copy. *Recommendation: treat as a hard rule until legal review says otherwise.*
